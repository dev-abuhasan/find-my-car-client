...
import { UserRegistrationTypes } from '../../services/redux/user/user-types';
import { register } from '../../services/redux/user/user-actions';


const Signup: React.FC = () => {
    const dispatch: ThunkDispatch<{}, {}, UserRegistrationTypes> = useDispatch();
    ...
    const handleSubmit = async (val: any) => {
        dispatch(register(val.firstName, val.lastName, val.email, val.password));
    };
                        ...
                        <Grid item xs={12} md={10} lg={8} sx={{ height: 'auto' }}>
                            <div className='text-center'>
                                ...
                                <div>
                                    ...
                                    <Link to={slug.SIGNIN} className="ms-2 text-decoration-none fw-bold">Sign In</Link>
                                </div>
                            </div>
                            <Froms
